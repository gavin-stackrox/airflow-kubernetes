...
class AbstractOpenshiftInstaller(ABC):
    def __init__(self, dag, config: DagConfig, release: OpenshiftRelease):
        ...
        self.rhacs_creds = {
            **var_loader.get_secret("rhacs_image_pull_secret_username", deserialize_json=True),
            **var_loader.get_secret("rhacs_image_pull_secret_password", deserialize_json=True)
        }
